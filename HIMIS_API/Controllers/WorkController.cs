...
select cast(AgencyID as varchar) as ID,'Superintending Engineer' as Desig,Mobileno as Mobile,1 RankID,'SE' as Role from AgencyMaster where  AgencyID='1001'
union all
select cast(AgencyID as varchar) as ID,AgencyName as Desig,Mobileno as Mobile,1 RankID,'HO_Infra' as Role from AgencyMaster where  AgencyID in (1005,1006,1010)
) b 
order by b.Rankid";
